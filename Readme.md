...
2. В Kafka UI можно просмотерть все топики приложения
3. В консоли приложения можно смотреть логи всех операций приложения. Работает через команду docker logs -f kafka-homework-two-app
